    ...
    <main className="section-container py-16">
      ...
      <header className="mb-12">
        ...
        <p className="section-subtitle max-w-2xl">
          Whether you want to talk deployment strategy, M&A, data projects, or a new idea,
          the fastest ways to reach me are email and LinkedIn.
        </p>
      </header>
            ...
            <ul className="space-y-4 text-sm text-text-secondary">
              ...
              <li className="flex items-center justify-between gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center rounded-full border border-border-subtle bg-background px-3 py-1.5 text-[11px] font-medium text-text-primary hover:border-brand-primary hover:text-brand-primary transition"
                >
                  Email me
                </a>
              </li>
            ...
            <form className="space-y-4 text-sm" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="deployment">Deployment strategy / technical PM roles</option>
